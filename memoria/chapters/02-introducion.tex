...
O obxectivo principal deste traballo é deseñar e desenvolver Telaria, unha aplicación 
móbil para a xestión integral de viaxes en grupo que cubra todo o ciclo de vida dunha 
viaxe nun único espazo compartido e que resolva a fragmentación e as carencias das 
solucións existentes descritas no apartado anterior. Non se trata só de implementar 
un conxunto de funcionalidades illadas, senón de ofrecer un produto integrado e 
coherente que substitúa o uso disperso de varias aplicacións xenéricas.

Este obxectivo principal concrétase nos seguintes subobxectivos funcionais:

\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\textwidth]{diagrams/funcionalidades-telaria.pdf}
  \caption{Funcionalidades principais de Telaria.}
  \label{fig:funcionalidades-telaria}
\end{figure}

\begin{itemize}
  \item \textbf{Ciclo de vida da viaxe.} A viaxe é a unidade central arredor da que se organiza
  ...
  \item \textbf{Gastos e liquidacións.} Cada membro pode rexistrar os gastos que paga, indicando
  ...
  \item \textbf{Eventos e calendario.} O grupo constrúe un itinerario común sobre un calendario
  ...
  \item \textbf{Documentos compartidos.} A viaxe dispón dun repositorio de documentos relevantes
  ...
  \item \textbf{Chat de grupo.} Cada viaxe inclúe unha sala de conversa propia para a
  ...
  \item \textbf{Asistente de intelixencia artificial.} Cada viaxe conta cun asistente
  ...
  \item \textbf{Rede de amizades e xestión de conta.} De maneira complementaria, a plataforma
...
A estes súmanse dous subobxectivos de carácter técnico: aplicar unha arquitectura 
API-first que estableza un contrato explícito entre frontend e backend, e empregar 
tecnoloxías multiplataforma modernas que permitan que a solución funcione tanto en iOS 
como en Android dende unha única base de código.

Para acadar estes obxectivos, Telaria deséñase como unha aplicación orientada a grupos 
de persoas que realizan viaxes conxuntas. Calquera usuario pode rexistrarse na 
plataforma e, a partir de aí, crear novas viaxes ou unirse a viaxes existentes 
mediante invitación, solicitude ou código QR. Dentro de cada viaxe, todos os membros 
acceden en igualdade de condicións ás funcionalidades da aplicación, sen distinción de 
roles nin dependencia dun organizador.

\newpage
\section{Relación da documentación que conforma a memoria}

A continuación descríbese brevemente o contido de cada sección e apéndice que conforma esta memoria.
