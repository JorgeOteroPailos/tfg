...
xeito que o cliente fala \textbf{directamente} co almacén de obxectos, descargando o
...
coidada independentemente do dispositivo, evitando problemas de carga de fontes e
...
\begin{itemize}
  ...
  \item \textbf{Dobre tema.} O tema claro/escuro axuda ás persoas sensibles á luz ou con baixa
        visión; o modo de aforro de datos reduce ademais a carga de imaxes. A
Figura~\ref{fig:ui-temas} ilustra os dous temas.
  ...
  \item \textbf{Escala tipográfica.} As compoñentes de texto compartidas limitan o factor
        máximo de escala (\texttt{maxFontSizeMultiplier}) para que os tamaños grandes non rompan
        os deseños.
  \item \textbf{Área de pulsación.} Os controis interactivos amplían a súa área de pulsación
        (\texttt{hitSlop}) ata o mínimo recomendado (44×44~pt), e as accións sensibles (saír da
        viaxe, eliminar a conta, pechar a sesión, etc.) inclúen pistas
        (\texttt{accessibilityHint}) que describen o seu efecto.
\end{itemize}
