...
\begin{itemize}
  ...
  \item \textbf{Novas funcionalidades}: Engadir novas
         funcionalidades como por exemplo maiores facilidades pra a xestión dos membros dunha viaxe, autenticación
         mediante proveedores externos.
  \item \textbf{Soporte web}: Aínda que a aplicación está pensada para dispositivos móbiles, un cliente web permitiría acceder á información desde calquera navegador.
\end{itemize}
