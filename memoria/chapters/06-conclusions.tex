...
\begin{itemize}
  ...
  \item \textbf{Accesibilidade}: estender o límite de escala da tipografía a todos os textos da
        interface, sobre a base do etiquetado para lectores de pantalla, o axuste de contraste
        WCAG~AA, o respecto do movemento reducido, as áreas de pulsación ampliadas e as pistas
        de accesibilidade xa implementados (ver a subsección de deseño da interface de usuario).
\end{itemize}
